...
class SupportsControllerTest < ActionController::TestCase
  ...
  test "should create support" do
    assert_difference('Support.count') do
      post :create, support: { Name: @support.Name, department: @support.department, done?: @support.done?, email: @support.email, message: @support.message }
    end
  ...
  test "should update support" do
    patch :update, id: @support, support: { Name: @support.Name, department: @support.department, done?: @support.done?, email: @support.email, message: @support.message }
    assert_redirected_to support_path(assigns(:support))
  end
